...
- bregonig.dll に perl\_license.txt と perl\_license\_jp.txt を同梱する [\#66](https://github.com/sakura-editor/sakura/issues/66)
...
- static で定義している変数を通常のローカル変数に変える [\#301](https://github.com/sakura-editor/sakura/pull/301) ([m-tmatma](https://github.com/m-tmatma))
...
- 仕様変更要望：「常駐しない」をデフォルトにしたい。 \#29 [\#32](https://github.com/sakura-editor/sakura/pull/32) ([berryzplus](https://github.com/berryzplus))
